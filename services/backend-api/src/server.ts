...
import { createPublicMarketplaceRouter } from "./routes/publicMarketplace.js";
...
export function createServer(deps: AppDependencies): Express {
  ...
  app.use("/tenants", createAnalyticsRouter(deps));
  ...
  app.use("/public/marketplace", createPublicMarketplaceRouter(deps));
