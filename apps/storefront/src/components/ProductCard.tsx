...
import type { PublicProductSummary } from "@fashion-platform/shared-types";

export function ProductCard({ storeSlug, product }: { storeSlug: string; product: PublicProductSummary }) {
  return (
